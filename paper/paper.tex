...
The consensus protocol to verify valid construction and execution of the will was implemented using a group of Nodes (comprised of representative \texttt{ConsensusNodes} from the \texttt{GoodNode}, \texttt{EvilNode}, and \texttt{InconsistentNode} classes discussed above) which each verified the validity of a transaction.
